...
**FAQ and live questions (slide 42 QR):** https://forms.gle/kymW1VEAELBHAVYa9

## Using the deck
- Open the live link in Chrome, press **F** for fullscreen.
- **→ / Space / PgDn** next build · **← / PgUp** previous · **↓ / ↑** skip slide · **Home / End** first / last.
- **O** overview · **S** sources · **H** or **?** help · **R** reset the current slide · **Esc** close.
- Direct link to any slide: add `#s12` (slide 12) or `#s12.3` (slide 12, build 3) to the URL.
- Works offline once loaded once; no external requests are made (fonts, images and the video are self-hosted).
